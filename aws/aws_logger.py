...
def aws_log_grabber(query, filters, start_date, end_date, start_time, end_time):
    ...
    # 2. we can make them submit the datetime as utc and convert that to a timestamp
